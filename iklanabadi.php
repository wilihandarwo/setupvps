...
define("REMOTE_REPOSITORY", "git@github.com:wilihandarwo/iklanabadi.com.git"); // The SSH URL to your repository
define("DIR", "/var/www/iklanabadi.com");                          // The path to your repostiroy; this must begin with a forward slash (/)
define("BRANCH", "refs/heads/main");                                 // The branch route
define("LOGFILE", "iklanabadi.log");                                       // The name of the file you want to log to.
